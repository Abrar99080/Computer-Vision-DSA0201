...
# Load images
img1 = cv2.imread("C:/Users/KUSUMA PRIYA/Downloads/Screenshot 2023-05-10 102959.jpg")
img2 = cv2.imread("C:/Users/KUSUMA PRIYA/Downloads/Screenshot 2023-05-10 102959.jpg")
